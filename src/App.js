...
class App extends Component {
    ...
    getInfo = (langue) => {
        const { information, footer, menu, about, competences, experiences, formation } = getSiteInfo(langue);
        this.setState({ information, footer, menu, about, competences, experiences, formation, currentLangue: langue })
    ...
    render() {
        const { information, footer, menu, about, competences, experiences, formation, currentLangue, currentPage } = this.state;
        return (
            <React.Fragment>
